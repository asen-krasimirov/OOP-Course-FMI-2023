...
void pointersExample() {
    ...
    std::cout << "Pointers Example Time: " << std::chrono::duration_cast<std::chrono::nanoseconds>(end - begin).count() << "ns" << std::endl;
}
...
void instancesExample() {
    ...
    auto end = std::chrono::high_resolution_clock::now();
    std::cout << "Instances Example Time: " << std::chrono::duration_cast<std::chrono::nanoseconds>(end - begin).count() << "ns" << std::endl;
}
